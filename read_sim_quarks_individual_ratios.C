...
void read_sim_quarks_individual_ratios() {
    ...
    TH1F *qePtCheckEta = new TH1F("qe_pt_check_eta","Heading;#hat{p}_{T} (GeV/c);Ratio", 35, 0.0, 120.0);
    ...
    qePtCheckEta->SetAxisRange(0,0.8,"Y");
    ...
    //legendqe->AddEntry(qePtTotal,"1","l");
    ...
    qmPtCheckEta->SetAxisRange(0,0.3,"Y");
